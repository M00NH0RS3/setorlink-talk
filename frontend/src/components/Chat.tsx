...
export default function Chat({ roomId }: { roomId: string }) {
    ...
    return (
        <div className="relative min-h-[70vh] h-full bg-gray-900 px-4 pt-4 md:w-[15%] hidden md:flex rounded-md m-3">
            <div className="h-full w-full">
                ...
                <form className="absolute bottom-4 inset-x-3" onSubmit={(e) => sendMessage(e)}>
                    <div className="flex relative">
                        ...
                        <button type="submit">
                            <Send className="absolute right-2 top-2.5 cursor-pointer" width={20} height={20} />
                        </button>
                    </div>
                </form>
            </div>
